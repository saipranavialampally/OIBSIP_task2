...
public class NumberGuessingGame {
    ...
    public static void main(String[] args)
    {
        ...
        for(int i=1;i<=maxrounds;i++)
        {
            ...
            while(attempts < maxattempts)
            {
                ...
                if(guess==genrandom)
                {
                    ...
                    score+= round;
                    System.out.print("Yahoo! You guessed the number successfully, Attempts= "+attempts+", Roundscore= "+round);
                    break;
                }
        ...
        System.out.println(" Thank you for playing.The game is over with round score as "+score);
        sc.close();
    }
}